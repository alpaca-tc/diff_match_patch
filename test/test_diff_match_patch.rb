...
class DiffTest < Test::Unit::TestCase
  ...
  def test_diff_half_match
    ...
    @dmp.diff_timeout = 1
    # No match.
    assert_equal(nil, @dmp.diff_half_match('1234567890', 'abcdef'))

    assert_equal(nil, @dmp.diff_half_match('12345', '23'))
    ...
    @dmp.diff_timeout = 0
    assert_equal(nil, @dmp.diff_half_match('qHilloHelloHew', 'xHelloHeHulloy'))
  end
  ...
  def test_patch_make
    ...
    assert_equal(expectedPatch, @dmp.patch_to_text(patches))
  ...
  def test_patch_split_max
    ...
    oldToText = @dmp.patch_to_text(patches)
    @dmp.patch_split_max(patches)
    assert_equal(oldToText, @dmp.patch_to_text(patches))
